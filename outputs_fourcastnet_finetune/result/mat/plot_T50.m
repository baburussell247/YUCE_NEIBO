% 加载MAT文件
matFile = 'D:\pythonprojects\fourcastnet21\outputs_fourcastnet_finetune\result\2023_5_20\true_data_T50.mat';
...
% 创建保存图片的文件夹
outputFolder = 'D:\pythonprojects\fourcastnet21\outputs_fourcastnet_finetune\result\2023_3_8\true-T50\';
...
for t = 1:timeSteps
    ...
    colormap(redblue3);  % 使用redblue3颜色映射
    colorbar;
    ...
    % 保存当前图像
    imageFileName = fullfile(outputFolder, ['time_step_' num2str(t) '.png']);
